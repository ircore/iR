...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("iRcoins"));
    case mBTC: return QString(QObject::tr("Milli-iRcoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-iRcoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
