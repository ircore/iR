...
{
    return GetBoolArg("-testnet", false) ? 18345 : 12001;
}
...
Value stop(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "Stop iRcoin server (and possibly override the detachdb config value).");
