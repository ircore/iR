...
unsigned int nStakeMinAge = 24 * nOneHour; // hours as zero time weight
unsigned int nStakeMaxAge = -1; //  
unsigned int nStakeTargetSpacing = 1 * 60; // 5-minute stakes spacing
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in iRcoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // iRcoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "iRcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "iRcoin Genesis Block";
        CTransaction txNew;
        txNew.nTime = 1508457600;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1508457600;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1508480304; // !fTestNet ? 1575379 : 46534;
...
//        hashGenesisBlock = block.GetHash();
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x2402f2ed6408a14f0d559ac1df2a67bfbaecb956f8c395c76818b96a70e66912"));
